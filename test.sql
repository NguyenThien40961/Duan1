...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 19, 2024 lúc 03:31 AM
...
CREATE TABLE `cart` (
  ...
  `price_all` int(11) NOT NULL DEFAULT 0,
...
(38, 'Z4ChH', '0387346512', 'Thai binh', 8, 10300000, 5, 'ko', '2024-01-13 10:50:10', 0),
(39, 'diYK8', '0387346512', 'Thai binh', 8, 20040000, 0, 'KO', '2024-01-16 05:03:57', 1),
(40, 'Z2adC', '0387346512', 'Thai binh', 8, 27340000, 4, '', '2024-01-16 05:55:57', 1),
(41, 'eBE1I', '0387346512', 'Thai binh', 8, 54630000, 3, '', '2024-01-16 06:00:10', 0);
...
(32, 14, 'Z4ChH', 1, 10250000),
(33, 21, 'diYK8', 1, 19990000),
(34, 12, 'Z2adC', 1, 27290000),
(35, 12, 'eBE1I', 2, 54580000);
...
(10, 'giá hơi cao', '2024-01-16', 12, 8);
...
(4, 'thienngph40961@fpt.edu.vn', 'Ảnh chụp màn hình 2023-09-09 000657.png', 'thienngph40961@fpt.edu.vn', '0387346512', 'Thái Bình', 'ECZbw!47VWy5vGJ', 1),
(5, 'Thien', 'user.png', '', '', '', '12345678', 1),
(8, 'thienngph40961@fpt.edu.vn', 'user.png', 'thienngph40961@fpt.edu.vn', '0387346512', 'Hà Nội', 'ECZbw!47VWy5vGJ', 1);
...
--
ALTER TABLE `cart_detail`
  MODIFY `cart_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `lk_cart_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);

--
-- Các ràng buộc cho bảng `cart_detail`
--
ALTER TABLE `cart_detail`
  ADD CONSTRAINT `lk_cdt_pro` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`);
...
--
ALTER TABLE `image`
  ADD CONSTRAINT `lk_pro_img` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`);

--
-- Các ràng buộc cho bảng `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `lk_pro_brand` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`brand_id`);
COMMIT;
